...
`/Users/chrisgorham/Websites/Stock-Stickies-Mobile` (`99redder/stock-stickies-mobile`, last
commit Jul 25, 2026) is an **old standalone copy** that predates this `mobile/` folder — it
still has the removed allocation donut and no Sites project id. Don't edit or release from it.
